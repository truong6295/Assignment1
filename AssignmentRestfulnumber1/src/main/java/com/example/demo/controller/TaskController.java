...
public class TaskController {
  ...
  //view all
    ...
    public ResponseEntity<?> creatTask(Task task, UriComponentsBuilder ucBuilder) throws ParseException {
    ...
    public ResponseEntity<?> updateTask(Task task) throws ParseException{
